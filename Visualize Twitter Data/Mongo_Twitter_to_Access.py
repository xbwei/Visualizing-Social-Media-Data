...
db_file = 'C:\\Project\\Paper\\Homeless\\tweet.mdb' #change the location to your Access file
...
for document in tweet_cursor:
    try:
        ...
        z =  10000.0/time_diff.total_seconds() # height of tweet points, relative time difference to current time, recent tweets on top
